...
class BluetoothLeService : Service() {
    ...
    fun setup() {
        bluetoothGattCallback = MyBluetoothGatt(this)
    }

    private lateinit var bluetoothGatt: BluetoothGatt
    private lateinit var bluetoothGattCallback: MyBluetoothGatt
    ...
    fun connect(device: BluetoothDevice): Boolean {
        ...
        bluetoothAdapter.let { adapter ->
            ...
            bluetoothGatt = device.connectGatt(
                this, false, bluetoothGattCallback, 0,
...
class DeviceControlActivity : AppCompatActivity() {
    ...
    fun CharaDisplay(mGattCharacteristics: MutableList<BluetoothGattCharacteristic>) {
        Row {
            mGattCharacteristics.forEach { mGattCharacteristic ->
    ...
    fun ConnectionScreen(device: BluetoothDevice) {
        Column(
            ...
            Text(
                "Name of the device: ${device.name}\nAddress of the device: ${device.address}\nButton Data: ${btData.toString()}",
                color = Color.Black
            )
